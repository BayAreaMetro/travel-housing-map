(function($) {
	...
	function htmapl(el, defaults, overrides) {
		...
		// the root element
		var root = $(el),
				container = el.insertBefore(po.svg("svg"), null),
	...
	$.fn.htmapl = function(defaults, overrides) {
	...
	// exports
	$.fn.htmapl.getFloat = getFloat;
	$.fn.htmapl.getInt = getInt;
	$.fn.htmapl.getLatLon = getLatLon;
	$.fn.htmapl.getExtent = getExtent;
	$.fn.htmapl.getBoolean = getBoolean;
	$.fn.htmapl.getXY = getXY;
